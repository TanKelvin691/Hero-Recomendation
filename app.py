...
hero_durability_input = st.number_input("Hero Durability", min_value=0)
hero_offence_input = st.number_input("Hero Offence", min_value=0)
hero_ability_input = st.number_input("Hero Ability", min_value=0)
hero_difficulty_input = st.number_input("Hero Difficulty", min_value=0)
